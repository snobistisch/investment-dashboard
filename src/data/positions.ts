...
export const positions: Position[] = [
  ...
  },
  {
    ticker: 'PEAQ',
    exchange: 'crypto',
    name: 'peaq (machine-economy L1)',
    sections: ['robotics'],
    factors: ['risk-appetite'],
    asOf: '2026-07-09',
    conviction: 1,
    stance: 'long',
    note: 'Token, not equity. Market cap not stated in the source. Overhang: ~43% of supply unlocking 2026–27 against ~15–20% circulating.',
  },
  {
    ticker: 'GEOD',
    exchange: 'crypto',
    ...
    conviction: 1,
    stance: 'long',
    note: 'Token, not equity. Market cap not stated. ~$200k/week on-chain revenue (~$7.8M annualised); 80% of data revenue buys back and burns GEOD.',
  },
  {
    ticker: 'BitRobot',
    exchange: 'crypto (Solana)',
    ...
    conviction: 1,
    stance: 'long',
    note: 'Token, not equity. Market cap not stated; $8M raised, Protocol Labs backed. Source flags this whole cluster: token mechanics ≠ equity, revenue tiny, unlock overhangs, mostly crypto-native sourcing.',
  },
  ...
  // =========================================================================
  {
    ...
    asOf: '2026-07-09',
    conviction: 3,
    edge: 'The institutional-infrastructure evidence is the strongest of the five and the price action the weakest: ~52% of global stablecoin supply, ~60% of tokenised RWA value, 31–32% of supply staked — against −65% from the Aug 2025 high. The section frames it explicitly as fundamentals vs flows.',
    stance: 'long',
