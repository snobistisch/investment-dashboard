    ...
    <div className={`mb-4 border ${border} bg-term-panel p-3`}>
      ...
      {snapshot && (
        <p className="mt-2 text-[11px] leading-relaxed text-term-dim">
          Equities {snapshot.providers.equity} · crypto{' '}
          <a
            className="text-term-dim underline decoration-dotted underline-offset-2 hover:text-term-text"
          ...
          · FX {snapshot.providers.fx}, {snapshot.fx.asOf}. positions.ts is not modified by any of
