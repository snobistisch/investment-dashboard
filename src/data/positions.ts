...
//   citrini    entry date  these rows carry no market data, so asOf is the date
//                          of the public source that named the ticker.
//
// ---------------------------------------------------------------------------
...
// columns are revenue and cash), biology carries two, and the Citrini universe
// carries none. Any "% by market cap" therefore covers a subset, and the
// exposure tab states its own coverage rather than implying it is complete.
//
// ---------------------------------------------------------------------------
...
/** Which side the dashboard describes. Citrini contains explicit shorts, and
 *  several names are flagged by their own section as context, not exposure —
...
// The six thematic research sections. Citrini is excluded from the headline
// concentration figure: it is third-party idea flow, not exposure.
...
export const positions: Position[] = [
  ...
  // =========================================================================
  // CRYPTO — 5 held + 1 benchmark. Single CoinGecko snapshot, 9 July 2026.
  ...
  },
  {
    ...
    conviction: 1,
    stance: 'long',
    note: 'Graded "early; demand-side unproven". Most current mining output is inference nobody requested or paid for. FDV $944M against $108M cap = heavy emission overhang. Do not confuse with "Perle", a different PRL.',
  },
  {
    ticker: 'NOCK',
    exchange: 'crypto',
  ...
  },
  {
    ...
    conviction: 1,
    stance: 'context',
    note: 'Benchmark row, explicitly NOT held. It is the incumbent the LIT thesis must beat: no VC, ~$202M Q2 fees, fresh June 2026 ATH.',
  },

  // =========================================================================
  // CITRINI — tickers named inside third-party idea entries.
  //
  // These are NOT positions. They are ideas reconstructed from free public
  // sources, disclosed late, without updates and without exits. They carry:
  //   - no market cap (the section has no market data at all)
  //   - conviction 1 (no tier in the source, and no view of our own)
  //   - asOf = the date of the public source that named the ticker
  //   - stance transcribed from the entry ('short' where Citrini was short)
  //
  // The exposure tab excludes them from the headline concentration figure and
  // reports them separately. They are here so the overlap table is complete.
  // =========================================================================

  // --- AI: Global Equity Beneficiaries (2023-05-31) ---
  {
    ticker: 'TSM',
    exchange: 'NYSE',
    name: 'TSMC',
    ...
    conviction: 1,
    stance: 'long',
    note: 'Named in two Citrini entries (AI global equity 2023-05-31, Edge AI 2024-07-08). The photonics note discusses TSMC\'s COUPE platform but deliberately does not cover it as a photonics name: "the exposure is immaterial to its P&L."',
  },
  {
    ticker: 'SMCI',
    exchange: 'Nasdaq',
  ...
  // --- AI losers, short side (2023-06-15) ---
  {
    ticker: 'CNXC',
    exchange: 'Nasdaq',
    name: 'Concentrix',
    ...
    conviction: 1,
    stance: 'short',
    note: 'Short leg: BPO/call centres disrupted by AI.',
  },
  {
    ticker: 'TASK',
    exchange: 'Nasdaq',
  ...
  },
  {
    ...
    conviction: 1,
    stance: 'pair',
    note: 'Long leg of the long BILL / short PAYX pair.',
  },
  {
    ticker: 'PAYX',
    exchange: 'Nasdaq',
    ...
    conviction: 1,
    stance: 'pair',
    note: 'Short leg of the long BILL / short PAYX pair.',
  },
  {
    ticker: 'BKNG',
    exchange: 'Nasdaq',
    ...
    conviction: 1,
    stance: 'pair',
    note: 'Long leg of long BKNG/EXPE vs short TRIP.',
  },
  {
    ticker: 'EXPE',
    exchange: 'Nasdaq',
  ...
  },
  {
    ...
    conviction: 1,
    stance: 'pair',
    note: 'Short leg of long BKNG/EXPE vs short TRIP.',
  },

  // --- GLP-1 winners and losers (2023-07-11) ---
  {
    ticker: 'LLY',
    exchange: 'NYSE',
    name: 'Eli Lilly',
  ...
  },
  {
    ...
    conviction: 1,
    stance: 'long',
    note: 'Second-order GLP-1 beneficiary (dating apps), per the entry.',
  },
  {
    ticker: 'BMBL',
    exchange: 'Nasdaq',
  ...
  },
  {
    ...
    conviction: 1,
    stance: 'short',
    note: 'Short leg: sleep apnea disrupted by GLP-1 weight loss.',
  },
  {
    ticker: 'INSP',
    exchange: 'NYSE',
  ...
  // --- Celestica long (2023-07-31) ---
  {
    ...
    conviction: 1,
    stance: 'long',
    note: 'The entry sits at the intersection of the 800G hyperscaler upgrade cycle and government-funded renewables — the same 800G cycle the photonics section is built on, disclosed by a third party in July 2023.',
  },

  // --- US Fiscal Primacy (2023-09-18) ---
  {
    ticker: 'ALB',
    exchange: 'NYSE',
    name: 'Albemarle',
    ...
    conviction: 1,
    stance: 'long',
    note: 'Exited per the free Aug 2024 retrospective.',
  },
  {
    ticker: 'JCI',
    exchange: 'NYSE',
  ...
  },
  {
    ...
    conviction: 1,
    stance: 'long',
    note: 'Added in the free Aug 2024 retrospective. Ticker 7011.T is the standard listing for Mitsubishi Heavy; the Citrini entry names the company, not a ticker. asOf is the month of the retrospective, day not stated.',
  },
  {
    ticker: 'FLR',
    exchange: 'NYSE',
    ...
    conviction: 1,
    stance: 'long',
    note: 'Added in the free Aug 2024 retrospective; entry names the company. asOf day not stated in the source.',
  },
  {
    ticker: 'ACM',
    exchange: 'NYSE',
  ...
  // --- 24 Trades for 2024 / water (2023-12-21) ---
  {
    ticker: 'AGUA.MX',
    exchange: 'Mexico',
    name: 'Grupo Rotoplas',
    ...
    conviction: 1,
    stance: 'long',
    note: 'The entry names "Rotoplas" without a ticker. AGUA.MX is its standard listing; flagged as an identification, not a source claim.',
  },
  {
    ticker: 'LAUR',
    exchange: 'Nasdaq',
  ...
  },
  {
    ...
    conviction: 1,
    stance: 'pair',
    note: 'Long leg of a GLP-1 pair. The entry writes "ZEAL"; ZEAL.CO is the Copenhagen listing — flagged as an identification.',
  },

  // --- Election 2024 baskets (2024-03-05) ---
  {
    ticker: 'GEO',
    exchange: 'NYSE',
    name: 'GEO Group',
  ...
  },
  {
    ...
    name: 'Palantir',
    sections: ['citrini'],
    factors: ['gov-capital', 'ai-adoption'],
    asOf: '2024-03-05',
    conviction: 1,
    stance: 'long',
  },
  {
    ...
    name: 'NextEra Energy',
    sections: ['citrini'],
    factors: ['gov-capital', 'rates-macro'],
    asOf: '2024-03-05',
    conviction: 1,
    stance: 'short',
    note: 'Short leg of long LNG/coal vs short clean energy.',
  },
  {
    ticker: 'ENPH',
    exchange: 'Nasdaq',
  ...
  },
  {
    ...
    conviction: 1,
    stance: 'long',
    note: 'Held in the entry as a social-instability hedge.',
  },

  // --- Edge AI / iPhone upgrade cycle (2024-07-08) ---
  {
    ticker: 'AAPL',
    exchange: 'Nasdaq',
    name: 'Apple',
    ...
    conviction: 1,
    stance: 'long',
    note: 'Basket closed per the free Aug 2024 retrospective.',
  },
  {
    ticker: 'QCOM',
    exchange: 'Nasdaq',
    name: 'Qualcomm',
    sections: ['citrini'],
    factors: ['ai-adoption', 'industrial-cycle'],
    chainLayer: 'component',
    asOf: '2024-07-08',
    conviction: 1,
    stance: 'long',
  },
  {
    ...
    conviction: 1,
    stance: 'long',
    note: 'The July 2026 drawdown anchor: $1,254.80 (25 Jun 2026) -> $737.88 (29 Jul 2026), a −41% move in five weeks. That figure was supplied by Matthias in Aug 2026 and is NOT in any section of this dashboard — the Citrini entry that names MU has not been updated since 2024.',
  },
  {
    ticker: '000660.KS',
    exchange: 'Korea',
    ...
    conviction: 1,
    stance: 'long',
    note: 'The entry writes "SK Hynix" without a ticker; 000660.KS is its Korea listing — flagged as an identification, not a source claim.',
  },
  {
    ticker: '6981.T',
    exchange: 'Tokyo',
    ...
    conviction: 1,
    stance: 'long',
    note: 'Entry names the company, not a ticker; 6981.T is its Tokyo listing.',
  },
  {
    ticker: '6762.T',
    exchange: 'Tokyo',
    ...
    conviction: 1,
    stance: 'long',
    note: 'Entry names the company, not a ticker; 6762.T is its Tokyo listing.',
  },
  {
    ticker: '3711.TW',
    exchange: 'Taiwan',
    ...
    conviction: 1,
    stance: 'long',
    note: 'Entry writes "ASE"; 3711.TW is its Taiwan listing (ASX on NYSE is the ADR) — flagged as an identification.',
  },

  // --- Chinese equities (2024-10-08) ---
  {
    ticker: 'PDD',
    exchange: 'Nasdaq',
    name: 'PDD Holdings',
    sections: ['citrini'],
    factors: ['rates-macro', 'gov-capital'],
    asOf: '2024-10-08',
    conviction: 1,
    stance: 'long',
    note: 'Part of a "stimulus barbell": long ADRs, short CNH.',
  },
  {
    ticker: 'BABA',
    exchange: 'NYSE',
  ...
  },
  {
    ...
    name: 'Weyerhaeuser',
    sections: ['citrini'],
    factors: ['industrial-cycle', 'rates-macro'],
    asOf: '2025-02-03',
    conviction: 1,
    stance: 'long',
  },
  ...
  },
  {
    ...
    name: 'D.R. Horton',
    sections: ['citrini'],
    factors: ['rates-macro', 'industrial-cycle'],
    asOf: '2025-02-03',
    conviction: 1,
    stance: 'short',
  },
  ...
  // --- AI buildout, next phase (2025-10-06) ---
  {
    ticker: 'SNDK',
    exchange: 'Nasdaq',
    name: 'SanDisk',
    ...
    conviction: 1,
    stance: 'long',
    note: 'THE CALIBRATION CASE. The entry note records the run from ~$40 to $268 (@Citrini7, 2025-11-11) and was never updated when SanDisk fell ~50% from its June 2026 peak — the schema had nowhere to put it and updates only arrive when a third party publishes one. The −50% figure was supplied by Matthias in Aug 2026 and is not in any section.',
  },

  // --- 2028 Global Intelligence Crisis (2026-02-22) ---
  {
    ticker: 'MA',
    exchange: 'NYSE',
    name: 'Mastercard',
    ...
    conviction: 1,
    stance: 'context',
    note: 'Named inside a scenario essay explicitly framed as "a scenario, not a prediction" — no stance is disclosed.',
  },
  {
    ticker: 'V',
    exchange: 'NYSE',
    ...
    conviction: 1,
    stance: 'context',
    note: 'Scenario essay only; no stance disclosed.',
  },
  {
    ticker: 'AXP',
    exchange: 'NYSE',
