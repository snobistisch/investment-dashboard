...
// Agentic and quantum carry one too. Robotics carries NONE (its table
...
export type Factor =
  ...
  | 'risk-appetite' // speculative-technology beta
...
// The five thematic research sections in the public-equity book.
...
export const positions: Position[] = [
  ...
  // =========================================================================
  // ROBOTICS — 15 tagged 'robotics', 14 transcribed here.
  // Data vintage "Q1 2026 reported".
  ...
  // =========================================================================
  // AGENTIC — 4 tagged 'agentic', 4 transcribed here. Figures are AS SUPPLIED
  ...
  },
  {
    ...
    asOf: '2026-07-09',
    conviction: 3,
    edge: 'Card-issuing infrastructure sits underneath agentic payments regardless of which agent wins.',
    stance: 'long',
