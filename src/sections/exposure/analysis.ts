...
export function exposureAxes(book: EffectivePosition[]): ExposureAxis[] {
  ...
  return [
    ...
    },
    {
      ...
      basis: 'derived',
      claim:
        'Carried as a factor, and understated by it. Beyond the names factored rates-macro, the photonics duration cohort (multiples above 100x) and the whole crypto sleeve are rates exposure that no factor label captures — see §06b of the photonics tab.',
    ...
    },
    {
      ...
      basis: 'stated',
      claim:
        'Fragmented across three tabs and bundled nowhere: the unconfirmed FCC transceiver ban (photonics), the GENIUS Act carve-out (agentic and crypto), and privacy-coin listing risk (crypto). Different regulators, same class of event.',
      tickers: ['CRCL', 'MQ', 'ZEC', 'LITE', 'COHR', 'AAOI'],
    },
    {
      id: 'china',
    ...
    },
    {
      ...
      basis: 'stated',
      claim:
        'The crypto Tier C names are pre-revenue positions with a public quote and most of their supply unissued. The equity side has no equivalent, which is why this axis is invisible in a factor table computed over both.',
      tickers: ['LIT', 'NOCK'],
    },
    {
      id: 'token-liquidity',
      label: 'Token liquidity and custody',
      basis: 'stated',
      claim:
        'Exit risk, not price risk. Five ranked crypto assets trade under $1m a day, and a tier-one delisting would break the ZEC position without touching the protocol. No equity in this book carries either.',
      tickers: ['ZEC', 'NOCK', 'LIT'],
    },
    {
      id: 'risk-appetite',
