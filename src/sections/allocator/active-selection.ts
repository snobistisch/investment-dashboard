...
export function emptyCandidate(id = crypto.randomUUID()): ActiveCandidateInput {
  return {
    id,
    ticker: '',
    thesis: '',
...
export function assessCandidate(
  ...
  if (position?.sections.includes('crypto')) blockers.push('Crypto belongs in its separate pilot.')
