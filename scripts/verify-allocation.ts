...
check(
  headerClaims.length === 5,
  `section headers: found ${headerClaims.length} parseable headers, expected 5`,
)
...
console.log(`universe: ${sizeableUniverse.length} sizeable equities = ${thesisUniverse.length} thesis + ${diversifierUniverse.length} diversifiers`)
