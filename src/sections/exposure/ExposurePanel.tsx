...
/** Last close in USD. Sub-dollar prices need the extra places to say anything. */
      ...
      <div className="mt-4">
        ...
        >
          ...
          <p className="mt-3 max-w-4xl text-[11px] leading-relaxed text-term-dim">
            ...
            days across every venue. 1D is the last session against the one before it. An{' '}
      ...
      <div className="mt-4 grid gap-4 lg:grid-cols-2">
        ...
        <Panel title="Chain layer — where the economics sit">
          ...
          <p className="mt-3 text-[11px] leading-relaxed text-term-dim">
            ...
            matters most. {chain.unclassified} carry no chain layer at all: the biology and
            ...
            <li>
              {source === 'none' ? (
                <>
                  ...
                  is the 7 Aug 2026 close; quantum, agentic and robotics are 9 July 2026;
